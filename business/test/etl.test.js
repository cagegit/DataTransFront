...
describe('etl相关操作测试', function () {
    ...
    it('查询etl配置 query_etl_config', function () {
        ...
        return etl.query_etl_config(req.body, res)
    ...
    it('etl schema信息查询 query_etl_user', function () {
        ...
        req.body.md5 = md5(JSON.stringify(req.body.request));
        return etl.query_etl_user(req.body, res)
            .then(function (result) {
                console.log('===', result);
                expect(result).to.be.an('object');
    ...
    it('etl table信息查询 query_etl_table', function () {
        ...
        req.body.md5 = md5(JSON.stringify(req.body.request));
        return etl.query_etl_table(req.body, res)
            .then(function (result) {
                console.log('===', result);
                expect(result).to.be.an('object');
    ...
    it('etl查询表列信息 query_column_list', function () {
        ...
        req.body.md5 = md5(JSON.stringify(req.body.request));
        return etl.query_column_list(req.body, res)
            .then(function (result) {
                console.log('===', result);
                expect(result).to.be.an('object');
    ...
    it('etl表达式合法性检查 legal_check_expression', function () {
        ...
        req.body.md5 = md5(JSON.stringify(req.body.request));
        return etl.legal_check_expression(req.body, res)
            .then(function (result) {
                console.log('===', result);
                expect(result).to.be.an('object');
    ...
    describe('etl增加列规则测试', function () {
        it('etl增加列规则保存 save_etl_add_config', function () {
            let req = {
                body: {
                    "request": {
                        "group": "group_270",
        ...
        it('etl增加列信息查询 query_etl_add_config', function () {
            ...
            req.body.md5 = md5(JSON.stringify(req.body.request));
            return etl.query_etl_add_config(req.body, res)
                .then(function (result) {
                    console.log('===', result);
                    expect(result).to.be.an('object');
        ...
        it('etl增加列规则删除 save_etl_table_rule', function () {
            ...
            req.body.md5 = md5(JSON.stringify(req.body.request));
            return etl.save_etl_table_rule(req.body, res)
                .then(function (result) {
                    console.log('===', result);
                    expect(result).to.be.a('string');
                    expect(result).to.contains('SUCCESS');
    ...
    describe('etl删除列规则测试', function () {
        it('etl删除列规则保存 save_etl_delete_config', function () {
            ...
            req.body.md5 = md5(JSON.stringify(req.body.request));
            return etl.save_etl_delete_config(req.body, res)
                .then(function (result) {
                    console.log('===', result);
                    expect(result).to.be.a('string');
                    expect(result).to.contains('SUCCESS');
        ...
        it('etl删除列规则查询 query_etl_delete_config', function () {
            ...
            req.body.md5 = md5(JSON.stringify(req.body.request));
            return etl.query_etl_delete_config(req.body, res)
                .then(function (result) {
                    console.log('===', result);
                    expect(result).to.be.an('object');
                    expect(result).to.include.keys('list');
    ...
    describe('etl映射列规则测试', function () {
        it('etl映射列规则查询 query_etl_map_config', function () {
            ...
            req.body.md5 = md5(JSON.stringify(req.body.request));
            return etl.query_etl_map_config(req.body, res)
                .then(function (result) {
                    console.log('===', result);
                    expect(result).to.be.an('object');
                    expect(result).to.include.keys('database');
        ...
        it('etl映射列规则保存 save_etl_map_config', function () {
            ...
            req.body.md5 = md5(JSON.stringify(req.body.request));
            return etl.save_etl_map_config(req.body, res)
                .then(function (result) {
                    console.log('===', result);
                    expect(result).to.be.a('string');
                    expect(result).to.contains('SUCCESS');
    ...
    describe('etl记录过滤规则测试', function () {
        it('etl记录过滤规则保存 save_etl_condition_config', function () {
            ...
            req.body.md5 = md5(JSON.stringify(req.body.request));
            return etl.save_etl_condition_config(req.body, res)
                .then(function (result) {
                    console.log('===', result);
                    expect(result).to.be.a('string');
                    expect(result).to.contains('SUCCESS');
        ...
        it('etl记录过滤规则查询 query_etl_condition_config', function () {
            ...
            req.body.md5 = md5(JSON.stringify(req.body.request));
            return etl.query_etl_condition_config(req.body, res)
                .then(function (result) {
                    console.log('===', result);
                    expect(result).to.be.an('object');
                    expect(result).to.include.keys('list');
    ...
    describe('etl表审计规则测试', function () {
        it('etl表审计规则保存 save_etl_transform_config', function () {
            ...
            req.body.md5 = md5(JSON.stringify(req.body.request));
            return etl.save_etl_transform_config(req.body, res)
                .then(function (result) {
                    console.log('===', result);
                    expect(result).to.be.a('string');
                    expect(result).to.contains('SUCCESS');
        ...
        it('etl表审计规则查询 query_etl_transform_config', function () {
            ...
            req.body.md5 = md5(JSON.stringify(req.body.request));
            return etl.query_etl_transform_config(req.body, res)
                .then(function (result) {
                    console.log('===', result);
                    expect(result).to.be.an('object');
                    expect(result).to.include.keys('database');
    ...
    describe('etl操作转换测试', function () {
        it('insert_to_update规则保存 save_etl_convert', function () {
            ...
            req.body.md5 = md5(JSON.stringify(req.body.request));
            return etl.save_etl_convert(req.body, res)
                .then(function (result) {
                    console.log('===', result);
                    expect(result).to.be.a('string');
                    expect(result).to.contains('SUCCESS');
        ...
        it('insert_to_update规则查询 query_etl_convert', function () {
            ...
            req.body.md5 = md5(JSON.stringify(req.body.request));
            return etl.query_etl_convert(req.body, res)
                .then(function (result) {
                    console.log('===', result);
                    expect(result).to.be.an('object');
    ...
    it('etl表规则查询 query_etl_table_rule', function () {
        ...
        req.body.md5 = md5(JSON.stringify(req.body.request));
        return etl.query_etl_table_rule(req.body, res)
            .then(function (result) {
                console.log('===', result);
    ...
    describe('etl批量规则测试', function () {
        it('etl批量过滤规则保存 save_batch_rule', function () {
            ...
            req.body.md5 = md5(JSON.stringify(req.body.request));
            return etl.save_batch_rule(req.body, res)
                .then(function (result) {
                    console.log('===', result);
                    expect(result).to.be.a('string');
        ...
        it('etl批量过滤值绑定 save_batch_codevalue', function () {
            ...
            req.body.md5 = md5(JSON.stringify(req.body.request));
            return etl.save_batch_codevalue(req.body, res)
                .then(function (result) {
                    console.log('===', result);
                    expect(result).to.be.a('string');
                    expect(result).to.include('SUCCESS');
