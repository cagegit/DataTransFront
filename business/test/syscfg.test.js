...
let md5 = require('md5');
let syscfg = require('../main/syscfg');
...
describe('系统设置', function () {
    ...
    it('保存monitor信息save_reporter_conf', function () {
        ...
        return syscfg.save_reporter_conf(req, res).then(function (result) {
    ...
    it('查询monitor信息query_reporter_conf', function () {
        ...
        return syscfg.query_reporter_conf(req, res).then(function (result) {
            console.debug('====', util.inspect(result, null, null));
    ...
    it('保存sender信息save_monitor_conf', function () {
        ...
        return syscfg.save_monitor_conf(req, res).then(function (result) {
    ...
    it('查询sender信息query_monitor_conf', function () {
        ...
        return syscfg.query_monitor_conf(req, res).then(function (result) {
